...
rotationAngle*Time.deltaTime);
        ...
        // Same as above, but setting the worldUp parameter to Vector3.left in this
        //example turns the camera on its side
...
//movementSpeed * Time.deltaTime, 0,  verticalInput * movementSpeed * 
//Time.deltaTime);
